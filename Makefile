PROGRAM_NAME := hepatocyte-cryopreservation
...
PhysiCell_custom_module_OBJECTS := hepatocyte-cryopreservation.o
...
hepatocyte-cryopreservation.o: ./custom_modules/hepatocyte-cryopreservation.cpp 
	$(COMPILE_COMMAND) -c ./custom_modules/hepatocyte-cryopreservation.cpp
...
untar: 
	...
	tar -xzf latest.tar
s/cancer_immune/custom_modules/* ./custom_modules/
