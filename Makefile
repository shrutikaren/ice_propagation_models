...
hepatocyte-sample:
	...
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/hepatocyte/main.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects/hepatocyte/Makefile .

Monte_carlo_linearArraycells-sample:

	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/Monte_carlo_linearArraycells/main.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects/Monte_carlo_linearArraycells/Makefile .


Monte_carlo_largeTissue-sample:

	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/Monte_carlo_largeTissue/main.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects/Monte_carlo_largeTissue/Makefile .

Gillespie-sample:

	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/Gillespie/main.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects/Gillespie/Makefile .

ovarian_follicle-sample:
	
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/ovarian_follicle/main.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects/ovarian_follicle/Makefile .



ovarian_follicle_freezing-sample:
	
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/ovarian_follicle_freezing/main.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects/ovarian_follicle_freezing/Makefile .

cryobiology-sample:
	cp ./sample_projects/cryobiology/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/cryobiology/main-cryobiology.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects/cryobiology/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml 
	cp ./sample_projects/cryobiology/config/* ./config/
